	...
	public static void main(String[] args) {
		...
		// 2. Repeat all the code above 10 times
			...
			for (int i = 0; i < thingo; i++) {
				randomNumber = randomMaker.nextInt(complimentsInAirQuotes.length);
